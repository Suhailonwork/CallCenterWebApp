...
### Predictive Dialer (Phase 1 Limitations)

3. **RATIO = 1 only**: One call per available agent. Phase 2: over-dialing (RATIO > 1).
4. **No AMD**: All answered calls go to agents (including answering machines).
5. **No abandon-rate cap**: Needed for regulatory compliance with over-dialing.
