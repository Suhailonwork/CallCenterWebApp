...
/**
 * GET /api/tl/campaigns/[id]/details — full campaign detail (calls,
 * recordings, notes, dispositions) for a campaign in the TL's groups.
 * Mirrors the admin details endpoint.
 */
